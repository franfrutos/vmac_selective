...
preregistered before data collection at \url{https://osf.io/f3bm8} and
\url{https://osf.io/f3bm8}. All data and analysis scripts are aviable
at: \url{https://osf.io/ezcrn}  The authors have no conflicts of
interest to disclose. This study was supported by the Ministerio de
Ciencia, Innovación y Universidades: Grants PID2023-148421NB-I00 and
...
using R, version 4.3.1 (\citeproc{ref-r_ref}{R Core Team,
2023})\footnote{R packages: \emph{lme4} (\citeproc{ref-lme4}{Bates et
  al., 2015}), \emph{betareg} (\citeproc{ref-betareg}{Cribari-Neto \&
  Zeileis, 2010}) and \emph{tidyverse} (\citeproc{ref-tidyverse}{Wickham
  et al., 2019}).}. We report how we determined our sample size, data
...
al. (\citeproc{ref-garre-frutos2025a}{2025}) (effect size:
\(\beta = 0.018\)), excluding trials from the first 48 trials where VMAC
is typically not observed (\citeproc{ref-garre-frutos2024}{Garre-Frutos
et al., 2024}; \citeproc{ref-garre-frutos2025a}{Garre-Frutos, Lupiáñez,
et al., 2025}). Power was estimated using R (version 4.3.1;
\citeproc{ref-r_ref}{R Core Team, 2023}) and the \emph{simr} package
(\citeproc{ref-simr}{Green \& MacLeod, 2016}). Simulations indicated
...
task (\citeproc{ref-garre-frutos2024}{Garre-Frutos et al., 2024}), in
which they searched for a diamond target among circle distractors. The
target always contained a horizontally or vertically oriented line
segment, while each circle contained a segment tilted by 45 degrees. On
most trials, one of the circles appeared in a uniquely colored singleton
distractor (orange and blue or pink and green, counterbalanced across
participants), which could be either a high- or low-value color.
Participants were instructed to locate and report the orientation of the
line segment within the diamond as quickly as possible by pressing the
key for horizontal or the key for vertical.
...
2008}). First, they rated the extent to which they believed the
...
(\(M_{\mathrm{VMAC}} = 1.2,\;95\%\,\mathrm{CI}[-5.3, 7.6]\))\footnote{As
  ...
  effect (\citeproc{ref-garre-frutos2024}{Garre-Frutos et al., 2024}),
  which was low
...
(\citeproc{ref-anderson2011}{Anderson et al., 2011}).
