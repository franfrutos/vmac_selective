...
- **Output/manuscript**: Contains compiled PDF versions of the manuscript and related documents for easy access.
...
- **Manuscript**: A folder with manuscript-related source files.
...
The editable manuscript sources are stored in [Manuscript](C:/Users/User/OneDrive/Escritorio/Projects/vmac_selective/Manuscript), including the main paper and anonymized version. For readers who simply want the compiled document, the PDF outputs are stored in [Output/manuscript](C:/Users/User/OneDrive/Escritorio/Projects/vmac_selective/Output/manuscript).
